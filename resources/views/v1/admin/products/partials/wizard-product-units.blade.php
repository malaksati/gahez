...
<div class="mt-3" x-show="!isVariable" x-cloak data-product-units-scope="simple">
                    ...
                    <tr>
                        <td>
                            ...
                            <select class="form-select form-select-sm"
                                ...
                                <template x-for="unit in catalogUnits" :key="`catalog_unit_${unit.id}`">
                        ...
                        <td>
                            <input type="text" class="form-control form-control-sm"
                                ...
                                x-model="row.sku"
                                @input="onProductUnitSkuInput(index)"
                                :readonly="!isEdit && row.unitSkuAutoGenerated"
                                :class="{ 'bg-light': !isEdit && row.unitSkuAutoGenerated }"
    ...
    <p class="form-text mb-0 mt-2" x-show="!isEdit">{{ __('messages.Product unit sku auto hint') }}</p>
</div>
