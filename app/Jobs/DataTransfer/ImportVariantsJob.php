...
use App\V1\DataTransfer\Imports\VariantImporter;
...
class ImportVariantsJob implements ShouldQueue
{
    ...
    public function handle(VariantImporter $importer, DataTransferService $dataTransfer): void
    {
        ...
        try {
            ...
            Log::error('Variant import job failed', ['batch_id' => $batch->id, 'message' => $exception->getMessage()]);
