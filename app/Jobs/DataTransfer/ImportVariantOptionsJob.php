...
use App\V1\DataTransfer\Imports\VariantOptionImporter;
...
class ImportVariantOptionsJob implements ShouldQueue
{
    ...
    public function handle(VariantOptionImporter $importer, DataTransferService $dataTransfer): void
    {
        ...
        try {
            ...
            Log::error('Variant option import job failed', ['batch_id' => $batch->id, 'message' => $exception->getMessage()]);
