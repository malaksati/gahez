...
use App\V1\DataTransfer\Imports\CategoryImporter;
...
class ImportCategoriesJob implements ShouldQueue
{
    ...
    public function handle(CategoryImporter $importer, DataTransferService $dataTransfer): void
    {
        ...
        try {
            ...
            Log::error('Category import job failed', [
                'batch_id' => $batch->id,
